...
const translations = {
    ...
    "results": "{count, plural, =0 {no results} =1 {{count} result} other {{count} results}}",
    ...
    "search_suggestion": {
        "tip_header": "To obtain more relevant results, you could try adding",
        "hint": "A {artistGenre} {type} for a {showType} in {location}",
        "hint_header": "For a more effective search, try to enter as many details as possible. For example:"
    },
    "filters": {
        "SHOW_TYPE": {
